...
class Config:
    """
    Minimal runtime configuration for the local retrieval server.
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--index_path",
        type=str,
        default=os.environ.get("WIKI_INDEX", str(repo_root / "wiki_index/e5_Flat.index")),
        help="Corpus indexing file.",
    )
    parser.add_argument(
        "--corpus_path",
        type=str,
        default=os.environ.get("WIKI_CORPUS", str(repo_root / "wiki_index/wiki-18.jsonl")),
    ...
    parser.add_argument(
        "--retriever_model",
        type=str,
        default=os.environ.get("E5_MODEL", "intfloat/e5-base-v2"),
    ...
    # Instantiate a global retriever so it is loaded once and reused.
